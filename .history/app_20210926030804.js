...
class Task {
    ...
    displayTask(callback) {
        ...
        list.innerHTML += `
        <li><fieldset> <legend><p><span id="hrs">by ${callback.hours}Hours</span>:<span id="mins">${callback.minutes}Minutes</span></p>
    ...
    static displayfromLs() {
        ...
        for (let i = 0; i < fromLs.length; i++) {
            list.innerHTML += `
            <li><fieldset> <legend><p><span id="hrs">In ${hrsLs[i]}Hours</span>:<span id="mins">${minLs[i]}Minutes</span></p>
            </legend>
