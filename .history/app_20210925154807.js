...
const minutes = document.querySelector('input[type=time]')
...
const timeTo = new Date(e.target.value);
timeTo.setHours(13);
timeTo.setMinutes()
const currrentTime = new Date;
timeTo.setHours(13)
console.log(timeTo)
console.log((timeTo.getHours()) - (currrentTime.getHours()));
console.log((timeTo.getMinutes()) - (currrentTime.getMinutes()));
console.log(date.value)
    // console.log(currrentTime.getHours())
