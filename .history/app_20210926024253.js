...
class Task {
    ...
    displayTask(callback) {
        ...
        list.innerHTML += `
        <li><fieldset> <legend><p><span id="hrs">I${callback.hours}Hours</span>:<span id="mins">${callback.minutes}Minutes</span></p>
    ...
    static displayfromLs() {
        ...
        for (let i = 0; i < fromLs.length; i++) {
            ...
            <li><fieldset> <legend><p><span id="hrs">${hrsLs[i]}Hours</span>:<span id="mins">${minLs}Minutes</span></p>
            </legend>
