...
class Task {
    ...
    static TimeUp() {
        ...
        for (let i = 0; i < dateLs.length; i++) {
            ...
            if (currentDate.getDate() == stored.getDate()) {
                // Swal({
                //     icon: 'notification',
                //     title: 'its time for',
                //     text: task[i]
            ...
            console.log(stored.getMinutes())
                // && (currentDate.getMonth() + 1) == (stored.getMonth() + 1) && currentDate.getHours() == stored.getHours() && currentDate.getMinutes == stored.getMinutes()
