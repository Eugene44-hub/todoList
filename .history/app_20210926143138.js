...
class Task {
    ...
    displayTask(callback) {
        ...
        list.innerHTML += `<li>${this.input}<i class="fas fa-trash-alt" id="delete"></i><i class="fas fa-check-square" id="checked"></i></li><label for=date>On ${date.value} By ${callback.hours}${callback.minutes}</label>`;
