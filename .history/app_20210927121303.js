...
class Task {
    ...
    static TimeUp() {
        ...
        for (let i = 0; i < dateLs.length; i++) {
            ...
            if (currentDate.getDate() == stored.getDate() && (currentDate.getMonth() + 1) == (stored.getMonth() + 1) && currentDate.getHours() == stored.getUTCHours()) {
                // Swal({
                //     icon: 'notification',
                //     title: 'its time for',
                //     text: task[i]
            ...
            console.log(stored.getUTCHours())
            console.log(currentDate.getMinutes())
            console.log(stored.getMinutes())
                //   && currentDate.getMinutes == stored.getMinutes()

            // console.log(stored.getDate())
            // console.log(stored.getMonth() + 1)
            // console.log(stored.getFullYear())
            // console.log(stored.getDate())
            // console.log(stored.getUTCHours())
            // console.log(stored.getTime())
            // console.log(currentDate.getTime())
            // console.log(stored.getTime())
            // console.log(currentDate.getTime())
            // console.log(dateLs[i])
            // console.log(hrsLs[i])
            // console.log(minLs[i])
            // console.log(stored)
        };
    ...
    setTimer() {
        ...
        console.log((timeTo.getUTCHours() < 10 ? '0' : '') + timeTo.getUTCHours())
        return {
